...
tex = Texture.from_surface(renderer, load_img("logo.png"))
img = Image(tex)
...
win2 = Window("2nd window", resizable=True, size=(800, 600), always_on_top=True)
win2.opacity = 1
win2.set_icon(load_img("logo.png"))
renderer2 = Renderer(win2)
tex2 = Texture.from_surface(renderer2, load_img("logo.png"))
renderer2.clear()
tex2.draw()
renderer2.present()
del tex2
    ...
    for event in pg.event.get():
        if event.type == pg.QUIT:
            ...
            if event.key == pg.K_ESCAPE:
                ...
                pg.image.save(readsurf, "logo.png")
